...
import org.landal.jee.mail.impl.MailServiceJavaMail;

public class EmailServiceJavaMailTest {

	private MailService emailService;

	public EmailServiceJavaMailTest() {
		this.emailService = new MailServiceJavaMail();
	}
